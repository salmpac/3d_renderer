...
Application::Application(std::filesystem::path obj_path)
    : runtime_(kWindowWidth, kWindowHeight, "3D Renderer"),
      view_(runtime_, kWindowWidth, kWindowHeight),
      camera_(BoundingBox{}, kFovY, static_cast<FloatType>(kWindowWidth) / kWindowHeight),
      screen_(Width{kWindowWidth}, Height{kWindowHeight}) {
